...
// нет, хромакейный фон, замкнутая обводка #080D14.
//
// УСТАРЕЛО. Диффузия эти требования соблюсти не может — у неё нет ни камеры,
// ни солнца, и разъезд по ракурсу между пропами виден в игре (ART_PIPELINE.md
// §1.1). GDD.md §3 переписан под stylized 3D: пропы и фигуры теперь строятся
// скриптом в Blender. Этот гонщик оставлен как есть — им сделан текущий арт, —
// но новый арт по нему не заказывается.
